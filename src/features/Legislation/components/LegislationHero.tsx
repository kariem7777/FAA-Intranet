...
export function LegislationHero({
  ...
  const {
    loading,
  } = useSelector((state: RootState) => state.documentsManagement);
  ...
  const displayTitle = modeContent[mode].title;
  const displayDescription = modeContent[mode].description;
  return (
    <div
      dir={isRTL ? "rtl" : "ltr"}
      ...
      <div className="px-12 py-8 relative z-10">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-2 justify-between">
            ...
            {/* Add Document Button - Only show in documents mode */}
            {mode === "documents" && onAddDocument && (
              <button
                onClick={onAddDocument}
                disabled={loading.add}
                className="flex items-center gap-2 px-6 py-3 rounded-lg transition-all hover:opacity-90"
                style={{
                  backgroundColor: loading.add ? "#9CA3AF" : "#C9A24D",
                  color: "#FFFFFF",
                  fontFamily: isRTL
                    ? "Dubai, Arial, sans-serif"
                    : "Inter, system-ui, sans-serif",
                  fontSize: "15px",
                  fontWeight: 500,
                  cursor: loading.add ? "not-allowed" : "pointer",
                  opacity: loading.add ? 0.6 : 1,
                }}
              >
                <Plus className="w-5 h-5" />
                <span>
                  {t('legislation.hero.addNewDocument')}
                </span>
              </button>
            )}
          </div>
        ...
        {/* Search Section - Only show in legislation mode */}
        {mode === "legislation" && (
                ...
                >
                  <span>
                    {selectedEntity
                      ...
                      : t('legislation.hero.selectEntityFirst')}
                  </span>
                  <ChevronDown
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder={t('legislation.documentsManagement.form.entityPlaceholder')}
                      ...
                      {selectedEntity && (
                        ...
                        >
                          <X className="w-4 h-4" />
                          {t('legislation.documentsManagement.clearSelection')}
                        </button>
                      )}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {t('legislation.hero.foundResults', { total: totalResults, count: searchResults.length })}
                </p>
              </div>
              <div
                className="divide-y"
