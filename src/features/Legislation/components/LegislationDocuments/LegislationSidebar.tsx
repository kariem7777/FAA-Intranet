  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`h-[calc(100vh-92px)] fixed border-r z-20 ${!loading && !error && categoryGroup?.categories?.length ? 'overflow-y-auto' : 'overflow-hidden'
          }`}
        style={{
      ...
      >
        <AnimatePresence mode="wait">
          {!isSidebarCollapsed && renderContent()}
        </AnimatePresence>
      </motion.div>
