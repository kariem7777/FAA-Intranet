...
export function LegislationHero({ title, description }: LegislationHeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex items-center px-20">
        <div className="flex items-start gap-6 max-w-275">
          ...
          <div>
            <h1 className="text-[38px] font-bold text-white mb-2 font-dubai">
              {isRTL ? displayTitle.ar : displayTitle.en}
            </h1>

            <p className="text-[17px] leading-[1.7] text-[#F0E3B8] max-w-190 font-dubai">
              {isRTL ? displayDescription.ar : displayDescription.en}
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Bottom gold accent */}
      <div className="absolute bottom-0 left-0 right-0 h-0.75 bg-[#C9A24D]" />
