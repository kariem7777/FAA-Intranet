...
export function LegalOpinionsLoading() {
    return (
...
export function LegalOpinionDetailLoading({ status }: { status?: number }) {
    return (
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-8 space-y-6">
                ...
                <div className="bg-white rounded-lg border-2" style={{ borderColor: status === 3 ? '#BBF7D0' : '#E5E7EB' }}>
                    {/* Header */}
                    <div
                        className="px-6 py-4 flex items-center justify-between border-b rounded-t-lg"
                        style={{ backgroundColor: status === 3 ? '#F0FDF4' : 'transparent', borderColor: status === 3 ? '#86EFAC' : '#E5E7EB' }}
                    >
                    ...
                    <div className="p-6">
                        <div
                            ...
                            style={{ backgroundColor: status === 3 ? '#F0FDF4' : '#F8FAFC', border: status === 3 ? '1px solid #BBF7D0' : '1px solid #E5E7EB' }}
                        >
                            <div className="space-y-2">
                                <Shimmer width="100%" height={16} />
                                <Shimmer width="100%" height={16} />
...
export function LegalOpinionsError({
    ...
    return (
        <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            {message && (
                <p className="mb-6 text-center max-w-md text-sm" style={{ color: '#64748B' }}>
                    {message}
                </p>
            )}
            {onRetry && (
