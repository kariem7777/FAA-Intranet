import svgPaths from "./svg-kqdxmrhk95";
    ...
    <div className="bg-white overflow-clip relative rounded-[16.4px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Primitive.div">
      <div className="absolute h-[581px] left-[347px] top-0 w-[495px]" data-name="HomePage">
        ...
        <div className="absolute h-[85.594px] left-[48px] top-[405.97px] w-[416px]" data-name="Container">
          <div className="absolute bg-[#7b282d] content-stretch flex h-[48px] items-center justify-center left-[-351px] rounded-[10px] top-[0.03px] w-[767px]" data-name="Link">
          ...
          <div className="absolute content-stretch flex h-[48px] items-center justify-center left-[-351px] p-px rounded-[10px] top-[62.03px] w-[767px]" data-name="Link">
        ...
        <div className="absolute h-[26px] left-[-292px] top-[524px] w-[756px]" data-name="Paragraph">
          <p className="absolute font-['Arial:Regular',sans-serif] leading-[25.6px] left-[377.5px] not-italic text-[#6b7280] text-[16px] text-center text-nowrap top-0 translate-x-[-50%]">Organized by Human Resources Department</p>
        </div>
